...
if __name__ == '__main__':
    ...
    report(args.r)
# -p rca/archive/agent-Bank.csv rca/archive/agent-Market-cloudbed-1.csv rca/archive/agent-Market-cloudbed-2.csv rca/archive/agent-Telecom.csv -q dataset/Bank/Bank/query.csv dataset/Market/Market/cloudbed-1/query.csv dataset/Market/Market/cloudbed-2/query.csv dataset/Telecom/Telecom/query.csv -r test/agent_claude.csv
